...
MODELS_ROUTE_JSON = os.getenv(
    "MODELS_ROUTE_JSON", os.path.join(MODELS_ROUTE, "models.json")
)
MODELS_ROUTE_TRASH = os.getenv(
    "MODELS_ROUTE_TRASH", os.path.join(MODELS_ROUTE, "trash")
)
